...
func NewInstallmentPlanModelAllOf(status PlanStatus) *InstallmentPlanModelAllOf {
	this := InstallmentPlanModelAllOf{}
	this.Status = status
	return &this
}
...
func (o InstallmentPlanModelAllOf) MarshalJSON() ([]byte, error) {
...
type NullableInstallmentPlanModelAllOf struct {
	value *InstallmentPlanModelAllOf
	isSet bool
}

func (v NullableInstallmentPlanModelAllOf) Get() *InstallmentPlanModelAllOf {
	return v.value
}

func (v *NullableInstallmentPlanModelAllOf) Set(val *InstallmentPlanModelAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableInstallmentPlanModelAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableInstallmentPlanModelAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstallmentPlanModelAllOf(val *InstallmentPlanModelAllOf) *NullableInstallmentPlanModelAllOf {
	return &NullableInstallmentPlanModelAllOf{value: val, isSet: true}
}

func (v NullableInstallmentPlanModelAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstallmentPlanModelAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
