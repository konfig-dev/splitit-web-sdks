...
public class IdentifierContract {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(refOrderNumber, installmentPlanNumber, extendedParams);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!IdentifierContract.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IdentifierContract` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
