...
public class PlanDataModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(totalAmount, currency, numberOfInstallments, terminalId, purchaseMethod, refOrderNumber, extendedParams);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PlanDataModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlanDataModel` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
