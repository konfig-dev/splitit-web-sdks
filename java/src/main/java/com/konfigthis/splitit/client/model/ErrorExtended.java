...
public class ErrorExtended {
  ...
  **/
   ...
   * @return the ErrorExtended instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, errorExtended.code) &&
        ...
        Objects.equals(this.additionalProperties, errorExtended.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, message, additionalInfo, extraData, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ErrorExtended>() {
           ...
           public ErrorExtended read(JsonReader in) throws IOException {
             ...
             ErrorExtended instance = thisAdapter.fromJsonTree(jsonObj);
