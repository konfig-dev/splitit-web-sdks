...
public class InstallmentPlanSearchResponse {
  ...
  private List<SearchInstallmentPlanResponseItem> planList = null;
  ...
  public InstallmentPlanSearchResponse addPlanListItem(SearchInstallmentPlanResponseItem planListItem) {
  ...
  **/
   ...
   * @return the InstallmentPlanSearchResponse instance itself
   */
  public InstallmentPlanSearchResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InstallmentPlanSearchResponse installmentPlanSearchResponse = (InstallmentPlanSearchResponse) o;
    return Objects.equals(this.planList, installmentPlanSearchResponse.planList)&&
        Objects.equals(this.additionalProperties, installmentPlanSearchResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InstallmentPlanSearchResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InstallmentPlanSearchResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstallmentPlanSearchResponse is not found in the empty JSON string", InstallmentPlanSearchResponse.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("PlanList") != null && !jsonObj.get("PlanList").isJsonNull()) {
        ...
        if (jsonArrayplanList != null) {
          ...
          for (int i = 0; i < jsonArrayplanList.size(); i++) {
            SearchInstallmentPlanResponseItem.validateJsonObject(jsonArrayplanList.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstallmentPlanSearchResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstallmentPlanSearchResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstallmentPlanSearchResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstallmentPlanSearchResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<InstallmentPlanSearchResponse>() {
           @Override
           public void write(JsonWriter out, InstallmentPlanSearchResponse value) throws IOException {
           ...
           @Override
           public InstallmentPlanSearchResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InstallmentPlanSearchResponse instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  * @return An instance of InstallmentPlanSearchResponse
  * @throws IOException if the JSON string is invalid with respect to InstallmentPlanSearchResponse
  */
  public static InstallmentPlanSearchResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstallmentPlanSearchResponse.class);
  }
