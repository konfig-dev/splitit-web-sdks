...
public class FailedResponse {
  ...
  **/
   ...
   * @return the FailedResponse instance itself
   */
  public FailedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.traceId, failedResponse.traceId) &&
        ...
        Objects.equals(this.additionalProperties, failedResponse.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FailedResponse>() {
           ...
           public FailedResponse read(JsonReader in) throws IOException {
             ...
             FailedResponse instance = thisAdapter.fromJsonTree(jsonObj);
