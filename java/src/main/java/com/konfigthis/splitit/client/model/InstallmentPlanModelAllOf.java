...
public class InstallmentPlanModelAllOf {
  ...
  **/
   ...
   * @return the InstallmentPlanModelAllOf instance itself
   */
  public InstallmentPlanModelAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.installmentPlanNumber, installmentPlanModelAllOf.installmentPlanNumber) &&
        ...
        Objects.equals(this.additionalProperties, installmentPlanModelAllOf.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(installmentPlanNumber, refOrderNumber, purchaseMethod, status, currency, originalAmount, amount, extendedParams, authorization, shopper, billingAddress, paymentMethod, installments, links, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InstallmentPlanModelAllOf>() {
           ...
           public InstallmentPlanModelAllOf read(JsonReader in) throws IOException {
             ...
             InstallmentPlanModelAllOf instance = thisAdapter.fromJsonTree(jsonObj);
