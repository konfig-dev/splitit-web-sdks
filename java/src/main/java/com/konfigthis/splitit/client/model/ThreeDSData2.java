...
public class ThreeDSData2 {
  ...
  public ThreeDSData2 ECI(String ECI) {
  ...
  **/
  ...
  public ThreeDSData2 CAVV(String CAVV) {
  ...
  **/
  ...
  public ThreeDSData2 XID(String XID) {
  ...
  **/
  ...
  public ThreeDSData2 directoryServerTxnId(String directoryServerTxnId) {
  ...
  **/
  ...
  public ThreeDSData2 threeDSVersion(String threeDSVersion) {
  ...
  **/
  ...
  public ThreeDSData2 transactionId(String transactionId) {
  ...
  **/
   ...
   * @return the ThreeDSData2 instance itself
   */
  public ThreeDSData2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThreeDSData2 threeDSData2 = (ThreeDSData2) o;
    return Objects.equals(this.ECI, threeDSData2.ECI) &&
        Objects.equals(this.CAVV, threeDSData2.CAVV) &&
        Objects.equals(this.XID, threeDSData2.XID) &&
        Objects.equals(this.directoryServerTxnId, threeDSData2.directoryServerTxnId) &&
        Objects.equals(this.threeDSVersion, threeDSData2.threeDSVersion) &&
        Objects.equals(this.transactionId, threeDSData2.transactionId)&&
        Objects.equals(this.additionalProperties, threeDSData2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThreeDSData2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThreeDSData2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThreeDSData2 is not found in the empty JSON string", ThreeDSData2.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThreeDSData2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThreeDSData2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThreeDSData2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThreeDSData2.class));

       return (TypeAdapter<T>) new TypeAdapter<ThreeDSData2>() {
           @Override
           public void write(JsonWriter out, ThreeDSData2 value) throws IOException {
           ...
           @Override
           public ThreeDSData2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThreeDSData2 instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  * @return An instance of ThreeDSData2
  * @throws IOException if the JSON string is invalid with respect to ThreeDSData2
  */
  public static ThreeDSData2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThreeDSData2.class);
  }
