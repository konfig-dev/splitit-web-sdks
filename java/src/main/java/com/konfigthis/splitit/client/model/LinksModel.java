...
public class LinksModel {
  ...
  **/
   ...
   * @return the LinksModel instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    LinksModel linksModel = (LinksModel) o;
    return Objects.equals(this.privacyPolicyUrl, linksModel.privacyPolicyUrl) &&
        Objects.equals(this.termsAndConditionsUrl, linksModel.termsAndConditionsUrl) &&
        Objects.equals(this.learnMoreUrl, linksModel.learnMoreUrl)&&
        Objects.equals(this.additionalProperties, linksModel.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(privacyPolicyUrl, termsAndConditionsUrl, learnMoreUrl, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LinksModel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LinksModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksModel is not found in the empty JSON string", LinksModel.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksModel.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksModel>() {
           @Override
           public void write(JsonWriter out, LinksModel value) throws IOException {
           ...
           @Override
           public LinksModel read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LinksModel instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  * @return An instance of LinksModel
  * @throws IOException if the JSON string is invalid with respect to LinksModel
  */
  public static LinksModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksModel.class);
  }
