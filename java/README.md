...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v2.2.3-blue)](https://central.sonatype.com/artifact/com.konfigthis/splitit-web-java-sdk/2.2.3)
...
dependencies {
   implementation "com.konfigthis:splitit-web-java-sdk:2.2.3"
}
```
...
* `target/splitit-web-java-sdk-2.2.3.jar`
* `target/lib/*.jar`
