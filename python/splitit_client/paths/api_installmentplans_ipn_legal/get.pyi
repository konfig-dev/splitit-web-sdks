...
from splitit_client.model.eligibility_terms_and_condition_response import EligibilityTermsAndConditionResponse as EligibilityTermsAndConditionResponseSchema

from splitit_client.type.failed_response import FailedResponse
from splitit_client.type.eligibility_terms_and_condition_response import EligibilityTermsAndConditionResponse
...
# Path params
IpnSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'ipn': typing.Union[IpnSchema, str, ],
    }
)
...
request_path_ipn = api_client.PathParameter(
    name="ipn",
    style=api_client.ParameterStyle.SIMPLE,
    schema=IpnSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = EligibilityTermsAndConditionResponseSchema
SchemaFor200ResponseBodyTextJson = EligibilityTermsAndConditionResponseSchema
SchemaFor200ResponseBodyTextPlain = EligibilityTermsAndConditionResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EligibilityTermsAndConditionResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_eligibility_terms_and_condition_mapped_args(
        self,
        ipn: str,
        ...
        if ipn is not None:
            _path_params["ipn"] = ipn
        args.header = _header_params
        args.path = _path_params
        return args

    async def _aget_eligibility_terms_and_condition_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/installmentplans/{ipn}/legal',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetEligibilityTermsAndCondition(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_eligibility_terms_and_condition(
        self,
        ipn: str,
        x_splitit_idempotency_key: str,
        x_splitit_touch_point: str,
        **kwargs,
        ...
        args = self._get_eligibility_terms_and_condition_mapped_args(
            ipn=ipn,
            x_splitit_idempotency_key=x_splitit_idempotency_key,
            x_splitit_touch_point=x_splitit_touch_point,
        )
        return await self._aget_eligibility_terms_and_condition_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def get_eligibility_terms_and_condition(
        self,
        ipn: str,
        x_splitit_idempotency_key: str,
        x_splitit_touch_point: str,
        ...
        return self._get_eligibility_terms_and_condition_oapg(
            header_params=args.header,
            path_params=args.path,
        )
